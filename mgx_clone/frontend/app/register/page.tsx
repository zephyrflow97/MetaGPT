    ...
    <div className="min-h-screen bg-mgx-bg-primary flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-mgx-bg-secondary to-mgx-bg-primary p-12 flex-col justify-between">
        ...
        <div>
          ...
          <p className="text-mgx-text-secondary text-lg">
            Create your free account and start generating complete projects with just a natural language description.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <h2 className="text-2xl font-bold text-mgx-text-primary mb-2">Create your account</h2>
          <p className="text-mgx-text-secondary mb-8">Join MGX Clone and start building amazing projects</p>
